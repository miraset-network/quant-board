// API response types shared between apps/api and apps/web.
// Keep this file in sync with the actual controller/service contracts.
...
export interface WalletActivityResponse {
  ...
  pagination: { page: number; per_page: number; is_last_page?: boolean } | null
  message?: string
}

# Token God Indexes — Ребаланс портфеля на основі Nansen Analytics
...
**Token God Indexes** — бекенд-сервіс для розумного ребалансу портфеля, який:
